...
const VERTICALS: Vertical[] = [
  {
    ...
    desc: "Arquitectura, decisiones técnicas y gestión de equipo. Bloques de 20 h o 40 h al mes, sin contrato laboral.",
    cta: "Ver paquetes",
  },
  {
    Icon: Sparkles,
    ...
    desc: "Integraciones reales que ahorran horas, no demos. Flujos internos, pipelines de datos, agentes con MCP.",
    cta: "Ver casos",
  },
  {
    Icon: CodeXml,
    ...
    tone: "green",
    title: "Prototipado",
    desc: "MVP funcional en 4–6 semanas. Next.js, TypeScript, un único developer senior al frente. Ideal para validar.",
    cta: "Hablemos",
  },
  {
    Icon: PenTool,
    ...
    tone: "ink",
    title: "Diseño & UX",
    desc: "Wireframes, sistemas de diseño y pasadas visuales. Operado por diseñadora senior, facturado por Rimamo.",
    cta: "Hablemos",
  },
];
